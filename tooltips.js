...
// @downloadURL  https://raw.githubusercontent.com/Xraydylan/PrUn_Tooltips_KAWA/Only-KAWA/tooltips.js
// @updateURL    https://raw.githubusercontent.com/Xraydylan/PrUn_Tooltips_KAWA/Only-KAWA/tooltips.js
// ==/UserScript==
        ...
        <table class="PrUnTools_Table">
          ...
          <tfoot>
            <tr class="bottom-border-cell">
              <td colspan="5">Updated on {UPDATE}</td>
            </tr>
          </tfoot>
        </table>
      </div>
...
function generateTooltipContent(ticker, title) {
    ...
    let html = tooltip_html.replace("{UPDATE}", kawa_update);
